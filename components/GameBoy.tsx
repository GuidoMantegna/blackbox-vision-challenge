...
const GameBoy: NextComponentType = () => {
  return (
      ...
      <div className={styles.body}>
        ...
        <div className={styles.screenBackground}>
          <div className={styles.screen}>
            ...
            <p className={`${styles.screenText} ${styles.question}`}>Who is the frontman of the band 30 Seconds to Mars?</p>
            <p className={`${styles.screenText} ${styles.answer}`}>- Jared Leto</p>
            <p className={`${styles.screenText} ${styles.answer}`}>- Gerard Way</p>
            <p className={`${styles.screenText} ${styles.answer} ${styles.selectedAnswer}`}>- Matthew Bellamy</p>
            <p className={`${styles.screenText} ${styles.answer}`}>- Mike Shinoda</p>
          </div>
        </div>
        {/* BUTTONS */}
        <div className={styles.buttons}>
          ...
          <div className={styles.arrowBTNS}>
            <div className={styles.arrowsY}></div>
            <div className={styles.arrowsX}></div>
          </div>
          {/* SELECT START AB */}
